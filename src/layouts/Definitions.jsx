...
const timeboxProps = {
    ...
    body: (
        <BoxContentWrapper>
            ...
            <List>
                <ListItem>
                    The maximum amount of time for an activity to take place
                </ListItem>
                <ListItem>
                    Keeps teams focused on accomplishing the task within the set
                    amount of time
                </ListItem>
            </List>
        </BoxContentWrapper>
...
const burndownProps = {
    ...
    body: (
        <BoxContentWrapper>
            ...
            <List>
                <ListItem>
                    A visual representation of the team’s progress
                </ListItem>
                <ListItem>
                    Plots the work committed vs the work delivered during a
                    Sprint
                </ListItem>
                <ListItem>
                    Updated every day to help ensure that the team is focused on
    ...
    body: (
        <BoxContentWrapper>
            ...
            <List>
                ...
                <ListItem>
                    Allows you to test an idea by exposing an early version of
                    the product to target users
                </ListItem>
...
const userStoriesProps = {
    ...
    body: (
        <BoxContentWrapper>
            ...
            <List>
                <ListItem>
                    A way to communicate and manage user requirements
                </ListItem>
                <ListItem>
                    Describe a feature and express the value of that feature
                </ListItem>
                <ListItem>
                    A placeholder for further discussion, shifting the focus
                    from writing about requirements to discussing them
                </ListItem>
                <ListItem>
                    Helps teams consider the perspective of the users of the
                    software
                </ListItem>
            </List>
        </BoxContentWrapper>
...
const estimatingProps = {
    ...
    body: (
        <BoxContentWrapper>
            ...
            <List>
                <ListItem>
                    A collaborative process where the whole team participates
                </ListItem>
                <ListItem>
                    Estimates are usually provided in relative values and are
